...
# Lint as: python3
"""The IIT Bombay English-Hindi Corpus."""
...
_HOMEPAGE_URL = "http://www.cfilt.iitb.ac.in/iitb_parallel/"
...
_VERSION = "3.0.0"
_BASE_NAME = "IITBParallel.{}.{}"
_BASE_URL = "http://www.cfilt.iitb.ac.in/~diptesh/{}-{}.txt.zip"
...
class IITBParallelHiEnConfig(datasets.BuilderConfig):
...
class IITBParallelHiEn(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        BibleParaConfig(
            lang1=lang1,
            lang2=lang2,
    ...
    BUILDER_CONFIG_CLASS = IITBParallelHiEnConfig
